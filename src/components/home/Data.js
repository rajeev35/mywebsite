...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Rajeev Kumar
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I am a creative Web Developer Based in India, and I am very passinate and dedicated to my work.</p>
